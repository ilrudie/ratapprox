...
//Defines a new type representing a fraction with a numerator and a denominator stored as indipendent values
...
/*
Calculate the rational representation (or best effort approximation bound by interations) of the provided float64 "input"
Loop:	
